...
const LearnMore: React.FunctionComponent<Props> = () => {
  const router = useRouter();
  const from = router.query.from;
  return (
    <Layout
      title="Learn more | Octogonal"
      colors={{
        background: "white",
        navigation: "",
        buttons: "",
        titles: "",
        footer: { bg: "", text: "", textHover: "" },
      }}
    >
      <Nav
        data={{ type: "learn", from: from != null ? from : "" }}
        color={{ self: "white", text: "black" }}
      />
